...
class PropertyRentBottomSheet extends StatelessWidget {
  const PropertyRentBottomSheet({super.key});
      ...
      child: SingleChildScrollView(
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          ListView.builder(
            ...
            itemCount: offerPropertyForRentList.length,
            shrinkWrap: true,
            physics: const NeverScrollableScrollPhysics(),
            itemBuilder: (context, index){
              return BottomSheetItemWidget(category: offerPropertyForRentList[index],);
            },
          )
